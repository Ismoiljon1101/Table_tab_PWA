 ...
 * Handles new user registration for both Restaurant Owners and Staff.
 */
            ...
            <div className="grid grid-cols-2 gap-3 mb-8 animate-slide-up">
                <button
                    ...
                    className={`flex flex-col items-center justify-center gap-2 p-4 rounded-2xl border-2 transition-all duration-200 active:scale-95 ${
                        mode === 'owner'
                            ? 'border-amber-600 bg-amber-50 text-amber-700 shadow-sm shadow-amber-200/50'
                ...
                {mode === 'owner' ? (
                    ...
                    <div>
                        <Input
                            ...
                            required
                        />
                        <p className="text-[11px] text-stone-500 mt-1.5 ml-1 italic">
                            Ask your manager for this ID to join their workspace.
                        </p>
                    </div>
                )}
